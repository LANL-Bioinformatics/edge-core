...
const workflowConfig = {
  ...
  assayDesign: {
    SPECIES_JSON: process.env.SPECIES_JSON || path.join(WORKFLOW_DATA_BASE_DIR, 'species.json'),
    SPECIES_TREE_JSON: process.env.SPECIES_TREE_JSON || path.join(WORKFLOW_DATA_BASE_DIR, 'speciesTree4UI.json'),
